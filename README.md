...
The system evaluates **10 model families: AutoReg, ARIMA, SARIMAX, Logistic Regression,
...
approaches to feature engineering, prediction targets, lag structures,
hyperparameter settings, and model selection. As a result, many individual
model configurations are trained and compared throughout the five experiments.
...
-   Compared **10 machine-learning and time-series model families**, with many
    individual configurations trained across different targets and experiments.
